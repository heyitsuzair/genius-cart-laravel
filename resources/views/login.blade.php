                    ...
                    <form action="/login" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('google.login') }}" class="w-full">
                                <button type="button"
                                    class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center  mr-2 mb-2">
                                    <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false"
